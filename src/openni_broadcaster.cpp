...
int main(int argc, char **argv) {
 ...
 //    XnCallbackHandle hUserCallbacks;
	...
	g_Broadcaster.AddListener(&g_PushDetector);
	g_Broadcaster.AddListener(&g_SwipeDetector);
	g_pSessionManager->AddListener(&g_Broadcaster);
	g_Broadcaster.RegisterActivate(&g_Context, &Broadcaster_OnActivate);
    g_Broadcaster.RegisterDeactivate(&g_Context, &Broadcaster_OnDeactivate);
